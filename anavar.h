...
Int_t anavar::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anavar::LoadTree(Long64_t entry)
{
...
void anavar::Show(Long64_t entry)
{
...
Int_t anavar::Cut(Long64_t entry)
{
